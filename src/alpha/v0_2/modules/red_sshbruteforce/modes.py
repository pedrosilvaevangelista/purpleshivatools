...
def InteractiveMode():
    ...
    print(f"{conf.PURPLE}{conf.BOLD}|{'SSH BRUTEFORCE - PURPLE SHIVA TOOLS':^75}|{conf.RESET}")
...
def run_attack():
    ...
    print(f"{conf.PURPLE}{conf.BOLD} INICIANDO ATAQUE SSH BRUTEFORCE {conf.RESET}")
...
def main():
    parser = argparse.ArgumentParser(description="SSH BruteForce - Purple Shiva Tools")
